...
/**
 ...
 - CKCalendarCellStateTodayDeselected:  A cell representing today, when the calendar view's selected date is not today.
 - CKCalendarCellStateDeselected:  A cell representing any date in the current scope besides for today, when the date is not selected.
 ...
 - CKCalendarMonthCellStateTodayDeselected: Deprecated. Use `CKCalendarCellStateTodayDeselected` instead.
 - CKCalendarMonthCellStateNormal: Deprecated. Use `CKCalendarCellStateDeselected` instead.
...
typedef NS_ENUM(NSUInteger, CKCalendarCellState) {
    ...
    CKCalendarCellStateTodayDeselected,
    CKCalendarCellStateDeselected,
    ...
    CKCalendarMonthCellStateTodayDeselected __deprecated_enum_msg("Use CKCalendarCellStateTodayDeselected instead."),
    CKCalendarMonthCellStateNormal __deprecated_enum_msg("Use CKCalendarCellStateDeselected instead."),
